...
const auth = async (user) => {
  ...
  if (response.status == 200) {
    ...
    // const ses = Session(user.username);
    // console.log(ses);
    localStorage.setItem("Name", user.username);
    // var ses = localStorage.getItem('Name');
    // console.log(ses);
    window.location = "http://localhost:3000/";
  } else {
    Swal.fire({
      // title: "Please check again your Username or Password",
      text: "Please check again your Username or Password",
      icon: "warning",
